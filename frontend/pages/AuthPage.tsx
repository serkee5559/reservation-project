      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-100 p-8 fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">
            {isLogin ? '정보를 입력하여 로그인하세요' : '회원가입 후 원하는 좌석을 예약하세요'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-indigo-600 text-white py-3 rounded-xl font-semibold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-colors"
          >
            {isLogin ? '로그인' : '회원가입'}
          </button>
        </form>
